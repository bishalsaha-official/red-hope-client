        ...
        <section className="min-h-screen flex items-center justify-center bg-cover bg-center p-4"
            ...
            <div className="max-w-5xl bg-white rounded-lg shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-6 md:p-10">
                    <h2 className="text-2xl font-bold text-red-600 mb-4">Register</h2>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        {errors.confirm_password && <p className="text-red-500 text-sm">Passwords do not match</p>}

                        <button type="submit" className="w-full bg-red-600 hover:bg-red-700 text-white py-2 rounded">
                            register
                        </button>
                    </form>
                    <p className="text-center text-xl my-5">Already have as donor? <Link to='/login'>Login</Link></p>
                </div>
            </div>
        </section>
    );
